...
describe('Login Test Cases', () => {
  beforeEach(async function  () {
    ...
    it('Should log into demo account when using enter key', async () => {
      await LOGIN_PAGE.logInWithEnter('jsmith@demo.io', 'Demo123!');
    ...
    it('Should deny access when invalid data is entered', async () => {
      await LOGIN_PAGE.logInWithSubmitButton('luciagonzalez@demo.io', 'Demo123!');
    ...
    it('Should remember the inputs when the button is checked', async () => {
      await LOGIN_PAGE.logInWithRememberMeChecked('jsmith@demo.io', 'Demo123!');
